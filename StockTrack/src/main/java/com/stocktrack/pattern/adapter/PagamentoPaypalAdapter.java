...
/**
 * Adapter che implementa il gateway applicativo traducendo i bean BCE nel formato richiesto da PagamentoPaypal. Isola il controller dalle API esterne concrete.
 */
