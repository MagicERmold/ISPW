...
final class InMemoryDataStore {
    ...
    static final Map<String, MovimentoInventario> MOVIMENTI_INVENTARIO = new LinkedHashMap<>();
    ...
    static {
        ...
        addProdotto(new Prodotto("EUR-IPHONE15", "iPhone 15", "Smartphone", 12, 3, new BigDecimal("799.00")));
        addProdotto(new Prodotto("EUR-MACBOOKAIR", "MacBook Air M3", "Notebook", 4, 2, new BigDecimal("1299.00")));
        addProdotto(new Prodotto("EUR-GALAXYS24", "Galaxy S24", "Smartphone", 10, 3, new BigDecimal("749.00")));
        addProdotto(new Prodotto("EUR-SAMSUNGTV55", "Samsung TV OLED 55", "TV", 6, 2, new BigDecimal("999.00")));
        addProdotto(new Prodotto("EUR-HUAWEIPURA70", "Huawei Pura 70", "Smartphone", 5, 2, new BigDecimal("699.00")));
        addProdotto(new Prodotto("EUR-HUAWEIMATEPAD", "Huawei MatePad 11", "Tablet", 8, 3, new BigDecimal("399.00")));
